...
function splitAndMerge(string, separator) {
  return string
    ...
    .map((word) => word.split("").join(separator)) // Split each word into characters and join them with the separator
    .join(" ") // Join all the resulting "words" back into a sentence with spaces
}
